...
## 程序说明  
### 1.注意事项
1. 目前该程序只能在[Firefox](http://www.firefox.com.cn/)或[Google Chrome](https://www.google.cn/chrome)上运行, 运行程序前请确保计算机已经安装了其中一款浏览器，并下载对应的浏览器驱动, **将驱动(.exe文件)与python.exe放置在同一文件夹中**, [这里](https://github.com/TUFE-I307/WeiboSpider/tree/master/BrowserDriver)给出了两种64位windows下的浏览器驱动的压缩文件, **下表给出了各系统下的浏览器驱动下载链接**  
